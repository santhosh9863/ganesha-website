    ...
    <section className="section-spacing relative overflow-hidden">
      ...
      <div className="relative layout-container">
        ...
        <div className="stack-desc-cards">
          ...
          >
            <div className="aspect-video rounded-2xl glass-gold flex items-center justify-center group cursor-pointer hover:border-gold-400/30 transition-all duration-500">
