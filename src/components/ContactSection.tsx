        ...
        <div className="stack-desc-cards">
          <div className="card-grid grid-cols-1 lg:grid-cols-2">
            ...
            >
              <div className="card-grid grid-cols-1 sm:grid-cols-2">
                <div className="flex flex-col gap-2">
                  ...
                  <input {...register("name")} type="text" placeholder="Enter your name" className="w-full h-14 px-5 bg-white border border-gold-400/15 rounded-xl text-[#1A1A1A] placeholder-[#4A453C]/30 focus:outline-none focus:border-gold-400 focus:ring-2 focus:ring-gold-400/20 transition-all duration-300 text-sm" />
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input {...register("email")} type="email" placeholder="Enter your email" className="w-full h-14 px-5 bg-white border border-gold-400/15 rounded-xl text-[#1A1A1A] placeholder-[#4A453C]/30 focus:outline-none focus:border-gold-400 focus:ring-2 focus:ring-gold-400/20 transition-all duration-300 text-sm" />
              ...
              <div className="flex flex-col gap-2">
                ...
                <input {...register("subject")} type="text" placeholder="What is this about?" className="w-full h-14 px-5 bg-white border border-gold-400/15 rounded-xl text-[#1A1A1A] placeholder-[#4A453C]/30 focus:outline-none focus:border-gold-400 focus:ring-2 focus:ring-gold-400/20 transition-all duration-300 text-sm" />
            ...
            >
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={item.label}>
                      ...
                      <p className="text-[#4A453C]/60 text-sm mt-1.5">{item.value}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="rounded-3xl bg-gradient-to-br from-gold-400/10 to-gold-400/5 border border-gold-400/20 card-padding">
                <h3 className="font-display text-lg font-bold text-[#1A1A1A] mb-4">🙏 Support Our Mission</h3>
                <p className="text-[#4A453C]/50 text-sm leading-premium mb-8">Your donations help us organize this grand celebration.</p>
                <button className="group relative inline-flex items-center justify-center gap-3 h-12 w-full bg-gradient-to-r from-gold-400 to-gold-500 hover:from-gold-500 hover:to-gold-400 text-white font-semibold rounded-[18px] text-sm transition-all duration-500 shadow-lg shadow-gold-400/20 hover:shadow-gold-400/40 hover:shadow-xl cursor-pointer focus-visible:outline-2 focus-visible:outline-gold-400 focus-visible:outline-offset-2 overflow-hidden">
